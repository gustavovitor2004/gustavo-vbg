        ...
        >
          ...
          <div className="hidden md:flex items-center gap-1 ml-2">
            ...
            <a href="https://wa.me/5575998596215" target="_blank" rel="noopener noreferrer"
              ...
              style={{
                padding: "7px 14px", borderRadius: "9999px", fontSize: "12px", fontWeight: 600,
                /* light: dark green text on light-green bg for AA contrast */
                color: isLight ? "#14532d" : "#fff",
                background: isLight ? "rgba(22,163,74,0.14)" : "rgba(37,211,102,0.15)",
                border: isLight ? "1px solid rgba(22,163,74,0.55)" : "1px solid rgba(37,211,102,0.35)",
                textDecoration: "none", whiteSpace: "nowrap", transition: "background 0.2s, border-color 0.2s",
              }}
              onMouseEnter={(e) => {
                const el = e.currentTarget as HTMLAnchorElement;
                el.style.background  = isLight ? "rgba(22,163,74,0.24)" : "rgba(37,211,102,0.25)";
                el.style.borderColor = isLight ? "rgba(22,163,74,0.72)" : "rgba(37,211,102,0.6)";
              }}
              onMouseLeave={(e) => {
                const el = e.currentTarget as HTMLAnchorElement;
                el.style.background  = isLight ? "rgba(22,163,74,0.14)" : "rgba(37,211,102,0.15)";
